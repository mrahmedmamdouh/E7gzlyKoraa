...
//initializing objects
    ...
    private void verifyVerificationCode(String code) {
        ...
        if(code.equals("") && mobile.equals(""))
            Toast.makeText(verifynumber.this,"Nothing to validate", Toast.LENGTH_SHORT).show();
        else {
            try {
                ...
                Toast.makeText(verifynumber.this,"Invalid credentials",Toast.LENGTH_LONG).show();
            }
                ...
                .addOnCompleteListener(verifynumber.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent = new Intent(verifynumber.this, searchActivity.class);
